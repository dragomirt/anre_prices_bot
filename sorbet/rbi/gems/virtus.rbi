...
class Virtus::Coercer
  ...
  def type; end
  include Anonymous_Virtus_Equalizer_11
end
module Anonymous_Virtus_Equalizer_11
...
class Virtus::Attribute
  ...
  include Anonymous_Virtus_Equalizer_12
end
class Virtus::Attribute::DefaultValue
  ...
  def value; end
  extend DescendantsTracker
  include Anonymous_Virtus_Equalizer_13
end
module Anonymous_Virtus_Equalizer_13
  def cmp?(comparator, other); end
  def hash; end
  def inspect; end
  include Virtus::Equalizer::Methods
...
module Anonymous_Virtus_Equalizer_12
  def cmp?(comparator, other); end
  def hash; end
  def inspect; end
  include Virtus::Equalizer::Methods
